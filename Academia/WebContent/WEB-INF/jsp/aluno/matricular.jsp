...
<body>
	...
	<br /> Matricular aluno:
	<c:out default="nome" value="${aluno.nome}"></c:out>
	<br>
	<br /> Modalidades atualmente matriculado:
		...
		<table align="center" width="81%" cellspacing="0" cellpadding="0"
			...
			<c:forEach var="modalidadeDoAluno" items="${modalidadesDoAluno}">
				<tr>
					...
					<td><c:url var="url_editar"
							value="/aluno/editarmatricula/${modalidadeDoAluno.id}" /> <form:form
							action="${url_editar}" method="POST">
							<input type="submit" value="Editar" />
						</form:form></td>
					<c:url var="url_remover"
						value="/aluno/removermatricula/${modalidadeDoAluno.id}" />
	...
	<form:form action="${url_matricular}" method='get'
