...
<body>
	...
	<form:form action="${url_1}" method="POST"
		...
		<br />
		<br />
		Numero de series: <form:input path="qtdSeries" />
		<font color="#FF0000"><c:out value="${SerieError}"></c:out></font>
		
		Qtde de repeticoes:<form:input path="qtdRepeticoes" />
		<font color="#FF0000"><c:out value="${repeticaoError}"></c:out></font>
		...
		<table align="center" width="81%" cellspacing="0" cellpadding="0"
			...
			<c:forEach var="exercicio" items="${carrinho}">
				<tr>
					...
					<td><c:url var="url_2" value="/ficha/${linha}/removerEditados" />
